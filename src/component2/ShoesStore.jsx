...
export default class ShoesStore extends Component {
    ...
    setModal = (shoes) => {
     ...
     renderShoes = () => {
        return this.shoesList.map((shoes) => {
            return <ProductsList shoes={shoes} setModal={this.setModal} key={shoes.id}/>
        })
    }
  render() {
    return (
        <div className='bgHinhAnh'>
            <nav className="header navbar-expand-lg navbar-light text-center pt-5">
                ...
                <div className="row">
                    <div className="col-4">
                        ...
                        <div className="content p-5">
                          <div className="ctSanPham p-5 text-left">
